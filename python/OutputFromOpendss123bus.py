# -*- coding: utf-8 -*-
"""
Created on Fri Jul 06 10:36:08 2018
    ...
    with open(YmatrixFile,'rb') as csvfileY:
        ...
        for i in range(3, len(mycsvY)): #for 123bus
            ...
            while j < len(row): # for 123bus
                ...
                j = j+2
                n = n+1
        REGindex = nodesOrder.index('150R')
        YGmatrix = numpy.delete(YGmatrix,(REGindex), axis=0)
        YGmatrix = numpy.delete(YGmatrix,(REGindex), axis=1)
        YBmatrix = numpy.delete(YBmatrix,(REGindex), axis=0)
        YBmatrix = numpy.delete(YBmatrix,(REGindex), axis=1)
        nodesOrder.remove('150R')
        networkGraph.delete_vertices('150R')
